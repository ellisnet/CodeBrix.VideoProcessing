...
public class ArgumentBuilderTest
{
    ...
    public void Builder_BuildString_IO_1()
    {
        ...
        (str).Should().Be("-i \"input.mp4\" \"output.mp4\" -y");
    }
        ...
        var str = FFMpegArguments.FromFileInput("input.mp4")
            .OutputToFile("output.mp4", true, opt => opt
                .WithVideoFilters(filterOptions => filterOptions
                    .Scale(VideoSize.Hd)))
            .Arguments;
        (str).Should().Be("-i \"input.mp4\" -vf \"scale=-1:720\" \"output.mp4\" -y");
    }
    ...
    public void Builder_BuildString_AudioCodec()
    {
        ...
        (str).Should().Be("-i \"input.mp4\" -c:a aac \"output.mp4\" -y");
    }
    ...
    public void Builder_BuildString_AudioBitrate()
    {
        ...
        (str).Should().Be("-i \"input.mp4\" -b:a 128k \"output.mp4\" -y");
    }
    ...
    public void Builder_BuildString_Quiet()
    {
        ...
        (str).Should().Be("-hide_banner -loglevel error -i \"input.mp4\" \"output.mp4\"");
    }
    ...
    public void Builder_BuildString_AudioCodec_Fluent()
    {
        ...
        (str).Should().Be("-i \"input.mp4\" -c:a aac -b:a 128k \"output.mp4\"");
    }
    ...
    public void Builder_BuildString_BitStream()
    {
        ...
        (str).Should().Be("-i \"input.mp4\" -bsf:a h264_mp4toannexb \"output.mp4\"");
    }
    ...
    public void Builder_BuildString_HardwareAcceleration_Auto()
    {
        ...
        (str).Should().Be("-i \"input.mp4\" -hwaccel auto \"output.mp4\"");
    }
    ...
    public void Builder_BuildString_HardwareAcceleration_Specific()
    {
        ...
        (str).Should().Be("-i \"input.mp4\" -hwaccel cuvid \"output.mp4\"");
    }
    ...
    public void Builder_BuildString_Concat()
    {
        ...
        (str).Should().Be("-i \"concat:1.mp4|2.mp4|3.mp4|4.mp4\" \"output.mp4\"");
    }
    ...
    public void Builder_BuildString_Copy_Audio()
    {
        ...
        (str).Should().Be("-i \"input.mp4\" -c:a copy \"output.mp4\"");
    }
    ...
    public void Builder_BuildString_Copy_Video()
    {
        ...
        (str).Should().Be("-i \"input.mp4\" -c:v copy \"output.mp4\"");
    }
    ...
    public void Builder_BuildString_Copy_Both()
    {
        ...
        (str).Should().Be("-i \"input.mp4\" -c:a copy -c:v copy \"output.mp4\"");
    }
    ...
    public void Builder_BuildString_DisableChannel_Audio()
    {
        ...
        (str).Should().Be("-i \"input.mp4\" -an \"output.mp4\"");
    }
    ...
    public void Builder_BuildString_DisableChannel_Video()
    {
        ...
        (str).Should().Be("-i \"input.mp4\" -vn \"output.mp4\"");
    }
    ...
    public void Builder_BuildString_AudioSamplingRate_Default()
    {
        ...
        (str).Should().Be("-i \"input.mp4\" -ar 48000 \"output.mp4\"");
    }
    ...
    public void Builder_BuildString_AudioSamplingRate()
    {
        ...
        (str).Should().Be("-i \"input.mp4\" -ar 44000 \"output.mp4\"");
    }
    ...
    public void Builder_BuildString_VariableBitrate()
    {
        ...
        (str).Should().Be("-i \"input.mp4\" -vbr 5 \"output.mp4\"");
    }
    ...
    public void Builder_BuildString_Faststart()
    {
        ...
        (str).Should().Be("-i \"input.mp4\" -movflags faststart \"output.mp4\"");
    }
    ...
    public void Builder_BuildString_Overwrite()
    {
        ...
        (str).Should().Be("-i \"input.mp4\" -y \"output.mp4\"");
    }
    ...
    public void Builder_BuildString_RemoveMetadata()
    {
        ...
        (str).Should().Be("-i \"input.mp4\" -map_metadata -1 \"output.mp4\"");
    }
    ...
    public void Builder_BuildString_Transpose()
    {
        var str = FFMpegArguments.FromFileInput("input.mp4")
            ...
            .Arguments;
        (str).Should().Be("-i \"input.mp4\" -vf \"transpose=2\" \"output.mp4\"");
    }
    ...
    public void Builder_BuildString_Mirroring()
    {
        var str = FFMpegArguments.FromFileInput("input.mp4")
            ...
            .Arguments;
        (str).Should().Be("-i \"input.mp4\" -vf \"hflip\" \"output.mp4\"");
    }
        ...
        var str = FFMpegArguments.FromFileInput("input.mp4")
            .OutputToFile("output.mp4", false, opt => opt
                .WithVideoFilters(filterOptions => filterOptions
                    ...
                    .Scale(200, 300)))
            .Arguments;
        (str).Should().Be("-i \"input.mp4\" -vf \"transpose=2, scale=200:300\" \"output.mp4\"");
    }
    ...
    public void Builder_BuildString_ForceFormat()
    {
        ...
        (str).Should().Be("-f mp4 -i \"input.mp4\" -f mp4 \"output.mp4\"");
    }
    ...
    public void Builder_BuildString_FrameOutputCount()
    {
        ...
        (str).Should().Be("-i \"input.mp4\" -vframes 50 \"output.mp4\"");
    }
    ...
    public void Builder_BuildString_VideoStreamNumber()
    {
        ...
        (str).Should().Be("-i \"input.mp4\" -map 0:1 \"output.mp4\"");
    }
    ...
    public void Builder_BuildString_FrameRate()
    {
        ...
        (str).Should().Be("-i \"input.mp4\" -r 50 \"output.mp4\"");
    }
    ...
    public void Builder_BuildString_Loop()
    {
        var str = FFMpegArguments.FromFileInput("input.mp4").OutputToFile("output.mp4", false, opt => opt.Loop(50))
            .Arguments;
        (str).Should().Be("-i \"input.mp4\" -loop 50 \"output.mp4\"");
    }
    ...
    public void Builder_BuildString_Seek()
    {
        ...
        (str).Should().Be("-ss 00:00:10.000 -i \"input.mp4\" -ss 00:00:10.000 \"output.mp4\"");
    }
    ...
    public void Builder_BuildString_EndSeek()
    {
        ...
        (str).Should().Be("-to 00:00:10.000 -i \"input.mp4\" -to 00:00:10.000 \"output.mp4\"");
    }
    ...
    public void Builder_BuildString_Shortest()
    {
        ...
        (str).Should().Be("-i \"input.mp4\" -shortest \"output.mp4\"");
    }
    ...
    public void Builder_BuildString_Size()
    {
        ...
        (str).Should().Be("-i \"input.mp4\" -s 1920x1080 \"output.mp4\"");
    }
    ...
    public void Builder_BuildString_Speed()
    {
        ...
        (str).Should().Be("-i \"input.mp4\" -preset fast \"output.mp4\"");
    }
    ...
    public void Builder_BuildString_DrawtextFilter()
    {
        ...
        (str).Should().Be("-i \"input.mp4\" -vf \"drawtext=text='Stack Overflow':fontfile=/path/to/font.ttf:fontcolor=white:fontsize=24:box=1:boxcolor=black@0.5:boxborderw=5:x=(w-text_w)/2:y=(h-text_h)/2\" \"output.mp4\"");
    }
    ...
    public void Builder_BuildString_DrawtextFilter_Alt()
    {
        ...
        (str).Should().Be("-i \"input.mp4\" -vf \"drawtext=text='Stack Overflow':fontfile=/path/to/font.ttf:fontcolor=white:fontsize=24\" \"output.mp4\"");
    }
    ...
    public void Builder_BuildString_SubtitleHardBurnFilter()
    {
        ...
        (str).Should().Be("-i \"input.mp4\" -vf \"subtitles='sample.srt':charenc=UTF-8:original_size=1366x768:stream_index=0:force_style='FontName=DejaVu Serif\\,PrimaryColour=&HAA00FF00'\" \"output.mp4\"");
    }
    ...
    public void Builder_BuildString_SubtitleHardBurnFilterFixedPaths()
    {
        ...
        (str).Should().Be(@"-i ""input.mp4"" -vf ""subtitles='sample( \\ \: \[ \] \, '\\\'' ).srt'"" ""output.mp4""");
    }
    ...
    public void Builder_BuildString_StartNumber()
    {
        ...
        (str).Should().Be("-i \"input.mp4\" -start_number 50 \"output.mp4\"");
    }
    ...
    public void Builder_BuildString_Threads_1()
    {
        ...
        (str).Should().Be("-i \"input.mp4\" -threads 50 \"output.mp4\"");
    }
    ...
    public void Builder_BuildString_Threads_2()
    {
        ...
        (str).Should().Be($"-i \"input.mp4\" -threads {Environment.ProcessorCount} \"output.mp4\"");
    }
    ...
    public void Builder_BuildString_Codec()
    {
        ...
        (str).Should().Be("-i \"input.mp4\" -c:v libx264 \"output.mp4\"");
    }
    ...
    public void Builder_BuildString_Codec_Override()
    {
        ...
        (str).Should().Be("-i \"input.mp4\" -c:v libx264 -pix_fmt yuv420p \"output.mp4\" -y");
    }
    ...
    public void Builder_BuildString_Duration()
    {
        ...
        (str).Should().Be("-i \"input.mp4\" -t 00:00:20 \"output.mp4\"");
    }
    ...
    public void Builder_BuildString_Raw()
    {
        ...
        (str).Should().Be(" -i \"input.mp4\"  \"output.mp4\"");
        ...
        (str).Should().Be("-i \"input.mp4\" -acodec copy \"output.mp4\"");
    }
    ...
    public void Builder_BuildString_ForcePixelFormat()
    {
        ...
        (str).Should().Be("-i \"input.mp4\" -pix_fmt yuv444p \"output.mp4\"");
    }
    ...
    public void Builder_BuildString_PanAudioFilterChannelNumber()
    {
        ...
        (str).Should().Be("-i \"input.mp4\" -af \"pan=2c|c0=c1|c1=c1\" \"output.mp4\"");
    }
    ...
    public void Builder_BuildString_PanAudioFilterChannelLayout()
    {
        ...
        (str).Should().Be("-i \"input.mp4\" -af \"pan=stereo|c0=c0|c1=c1\" \"output.mp4\"");
    }
    ...
    public void Builder_BuildString_PanAudioFilterChannelNoOutputDefinition()
    {
        ...
        (str).Should().Be("-i \"input.mp4\" -af \"pan=stereo\" \"output.mp4\"");
    }
    ...
    public void Builder_BuildString_DynamicAudioNormalizerDefaultFormat()
    {
        ...
        (str).Should().Be("-i \"input.mp4\" -af \"dynaudnorm=f=500:g=31:p=0.95:m=10.0:r=0.0:n=1:c=0:b=0:s=0.0\" \"output.mp4\"");
    }
    ...
    public void Builder_BuildString_DynamicAudioNormalizerWithValuesFormat()
    {
        ...
        (str).Should().Be("-i \"input.mp4\" -af \"dynaudnorm=f=125:g=13:p=0.92:m=5.1:r=0.5:n=0:c=1:b=1:s=0.3\" \"output.mp4\"");
    }
    ...
    public void Builder_BuildString_Audible_AAXC_Decryption()
    {
        ...
        (str).Should().Be("-audible_key 123 -audible_iv 456 -i \"input.aaxc\" -map_metadata 0 -id3v2_version 3 -vn -c:a copy \"output.m4b\" -y");
    }
    ...
    public void Builder_BuildString_PadFilter()
    {
        ...
        (str).Should().Be("-i \"input.mp4\" -vf \"pad=width=max(iw\\,ih):height=ow:x=(ow-iw)/2:y=(oh-ih)/2:color=violet:eval=frame\" \"output.mp4\"");
    }
    ...
    public void Builder_BuildString_PadFilter_Alt()
    {
        ...
        (str).Should().Be("-i \"input.mp4\" -vf \"pad=aspect=4/3:x=(ow-iw)/2:y=(oh-ih)/2:color=violet:eval=frame\" \"output.mp4\"");
    }
    ...
    public void Builder_BuildString_MultiOutput()
    {
        var str = FFMpegArguments.FromFileInput("input.mp4")
            ...
            .Arguments;
        (str).Should().Be("""-i "input.mp4" -c:a copy -c:v copy "output.mp4" -y -c:a copy -c:v copy -f mpegts "output.ts" -f webm http://server/path""");
    }
    ...
    public void Builder_BuildString_MultiInput()
    {
        ...
        var str = FFMpegArguments
            ...
            .Arguments;
        (str).Should().Be("-i \"1.mp3\" -i \"2.mp3\" -i \"3.mp3\" -i \"4.mp3\" -filter_complex \"[0:0][1:0][2:0][3:0]amix=inputs=4:duration=longest:dropout_transition=1:normalize=0[final]\" -map \"[final]\" -c:a libmp3lame -b:a 128k -ar 48000 -map_metadata -1 -ac 2 -write_xing 0 -id3v2_version 0 \"output.mp3\" -y");
    }
    ...
    public void Pre_VerifyExists_SomeFilesNotExist()
    {
        ...
        {
            // Act & Assert
            Assert.Throws<FileNotFoundException>(() => argument.Pre());
        }
        finally
        {
            // Cleanup
    ...
    public void Concat_Escape()
    {
        ...
        (arg.Values.ToArray()).Should().BeEquivalentTo(new[] { @"file 'Heaven'\''s River\05 - Investigation.m4b'" });
    }
    ...
    public void InputPipe_MaxLength_ShorterThanMacOSMax()
    {
        ...
        (pipePath.Length).Should().BeLessThan(104);
    }
    ...
    public void OutputPipe_MaxLength_ShorterThanMacOSMax()
    {
        ...
        (pipePath.Length).Should().BeLessThan(_macOsMaxPipePathLength);
    }
}
